...
def _training_function(config: dict[str, Any]) -> None:
    ...
    elif finetuning_args.stage == "sft_pg":
        from .sft_pg.workflow import run_sft_pg
        run_sft_pg(model_args, data_args, training_args, finetuning_args, generating_args, callbacks)
    ...
    elif finetuning_args.stage == "dpo_pg":
        from .dpo_pg.workflow import run_dpo_pg
        run_dpo_pg(model_args, data_args, training_args, finetuning_args, callbacks)
